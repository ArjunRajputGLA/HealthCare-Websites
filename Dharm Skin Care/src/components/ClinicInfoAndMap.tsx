      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-[#FAFAF8] border border-slate-200 shadow-sm">
              <div className="flex items-center gap-3 mb-5 pb-3 border-b border-slate-200">
                <div className="w-10 h-10 rounded-xl bg-[#0B4F6C] text-white flex items-center justify-center">
                  <Clock className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="font-serif font-bold text-slate-900 text-lg">Weekly OPD Timings</h3>
                  <p className="text-xs text-slate-500">Dharm Skin & Eye Centre Schedule</p>
                </div>
              </div>
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center justify-between p-2.5 rounded-xl text-sm transition-colors ${
                        isCurrentDay
                          ? 'bg-[#0B4F6C]/10 font-semibold text-[#0B4F6C] border border-[#0B4F6C]/20'
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <span>{h.day}</span>
                        {isCurrentDay && (
                          <span className="text-[10px] bg-[#0B4F6C] text-white px-2 py-0.5 rounded-full font-bold">
                            Today
                          </span>
                        )}
                      </div>
            ...
            <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm space-y-4">
              <div className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-[#E8A33D] shrink-0 mt-1" />
                <div>
              ...
              <div className="flex items-start gap-3 pt-3 border-t border-slate-100">
                <Phone className="w-5 h-5 text-[#0B4F6C] shrink-0 mt-1" />
                <div>
                  <div className="text-xs font-bold text-slate-500 uppercase">Phone (Tap to call)</div>
                  <a
                    href={`tel:${CLINIC_INFO.phoneRaw}`}
                    className="text-base font-bold text-[#0B4F6C] hover:underline"
                  >
                    {CLINIC_INFO.phone}
                  </a>
                </div>
              ...
              <a
                ...
                className="w-full py-3 rounded-xl bg-[#0B4F6C] hover:bg-[#07384D] text-white font-semibold text-sm flex items-center justify-center gap-2 transition-all shadow-sm"
              >
          ...
          <div className="lg:col-span-7 h-full min-h-[420px] rounded-3xl overflow-hidden border border-slate-200 shadow-lg relative bg-slate-100">
            ...
            />
            {/* Map Overlay Badge */}
            <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-md p-3 rounded-xl shadow-lg border border-slate-200 text-xs font-semibold text-slate-900 flex items-center gap-2">
              <div className="w-3 h-3 rounded-full bg-[#0B4F6C] animate-ping" />
